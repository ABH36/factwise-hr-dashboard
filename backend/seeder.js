...
const rawEmployees = [
  ...
  { "id": 9, "firstName": "James", "lastName": "Anderson", "email": "james.anderson@company.com", "department": "HR",
    "position": "HR Specialist", "salary": 58000, "hireDate": "2021-08-30", "age": 28, "location": "Austin", "performanceRating": 4.0, "projectsCompleted": 7, "isActive": true, "skills": ["Recruitment", "Employee Relations", "HRIS"], "manager": "Karen White" },
  ...
  { "id": 20, "firstName": "Stephanie", "lastName": "Lopez", "email": "stephanie.lopez@company.com", "department": "Marketing", "position": "Digital Marketing Specialist", "salary": 64000, "hireDate": "2021-12-20", "age": 26, "location": "Phoenix",
    "performanceRating": 3.8, "projectsCompleted": 7, "isActive": true, "skills": ["Google Ads", "Facebook Ads", "Email Marketing"], "manager": "Michael Brown" }
];
...
const formattedEmployees = rawEmployees.map(emp => {
  return {
    ...
    salary: emp.salary * 83, 
    skills: emp.skills,
    projectsCompleted: emp.projectsCompleted,
    manager: emp.manager || "Board", 
    yearsAtCompany: new Date().getFullYear() - new Date(emp.hireDate).getFullYear(), 
